...
def sendEmail(contacts):
    ...
    EMAIL_ADDRESS = 'navneetguptaend@gmail.com'
    EMAIL_PASSWORD = 'Nav@54321'
    ...
    msg.add_alternative(
        email_message.format(country_name=country_name1, total=total1, new=new1, active=active1, critical=critical1,
                             recovered=recovered1), subtype='html')
