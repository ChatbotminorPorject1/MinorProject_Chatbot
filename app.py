...
def configureDataBase():
    client = MongoClient(
        "mongodb+srv://Covid_19-Bot:<Project_1@Minor>@cluster0.edswa.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
    return client.get_database('covid_19BotDB')
